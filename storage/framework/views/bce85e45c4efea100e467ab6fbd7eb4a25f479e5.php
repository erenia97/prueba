...
'                   <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('productos.update',$producto->id_productos)); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('codigo') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="codigo" type="number" class="form-control" name="codigo" value="<?php echo e($producto->codigo); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('sku') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="sku" type="number" readonly="readonly" class="form-control" name="sku" value="<?php echo e($producto->sku); ?>" required>
                       ...
                       <div class="form-group<?php echo e($errors->has('precio') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="precio" type="number" class="form-control" name="precio" value="<?php echo e($producto->precio); ?>" required>
